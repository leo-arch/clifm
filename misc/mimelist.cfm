...
X:E:^(cbr|cbz)$=zathura
X:E:^cfm$=$EDITOR;$VISUAL;nano;nvim;vim;vis;vi;mg;emacs;ed;micro;kakoune;leafpad;mousepad;featherpad;gedit;kate;pluma
!X:E:^cfm$=$EDITOR;$VISUAL;nano;nvim;vim;vis;vi;mg;emacs;ed;micro;kakoune
...
X:(^text/.*|application/json|inode/x-empty)=$EDITOR;$VISUAL;nano;nvim;vim;vis;vi;mg;emacs;ed;micro;kakoune;leafpad;mousepad;featherpad;kate;gedit;pluma
!X:(^text/.*|application/json|inode/x-empty)=$EDITOR;$VISUAL;nano;nvim;vim;vis;vi;mg;emacs;ed;micro;kakoune
