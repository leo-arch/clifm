...
complete -c clifm -l cwd-in-title -d 'Print current directory in the window title'
...
complete -c clifm -l no-columns -d 'Disable columned file listing'
...
complete -c clifm -l no-files-counter -d 'Disable the file counter for directories'
