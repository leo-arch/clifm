...
* `version 1.4.1`:
  ...
  - `Prompt`, `WarningPromptStr`, `DividingLine`, and `FfzTabOptions` options were moved from the config file to the color scheme file to get a centralized and single theming file.
