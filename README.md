...
* `Development`
  - Ported to SunOS (including doors support).
...
Successfully tested and running flawlessly on Linux, Termux (Android), FreeBSD, NetBSD, OpenBSD, DragonFly, MacOS, Haiku, SunOS, and Cygwin, on x86, ARM, PowerPC, and RISC-V architectures.
