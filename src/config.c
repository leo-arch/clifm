...
X:^image/.*=display %%x;pqiv %%x;sxiv %%x;nsxiv %%x;gpicview %%x;qview %%x;qimgv %%x;mirage %%x;ristretto %%x;loupe %%x;eog %%x;eom %%x;xviewer %%x;viewnior %%x;nomacs %%x;geeqie %%x;gwenview %%x;gthumb %%x;gimp %%x\n\
