...
X:^application/(zip|gzip|zstd|x-(7z-compressed|xz|bzip*|tar|iso9660-image|lzma|lzop|lzip)|vnd.rar)=ad;xarchiver %%x;lxqt-archiver %%x;ark %%x\n\
!X:^application/(zip|gzip|zstd|x-(7z-compressed|xz|bzip*|tar|iso9660-image|lzma|lzop|lzip)|vnd.rar)=ad\n\
\n\
# PDF\n\
