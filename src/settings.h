...
#define DEF_MOUSE_SUPPORT 1
#define DEF_MOUSE_OPEN_ON_DOUBLE_CLICK 1
#define DEF_MOUSE_INSERT_ON_SINGLE_CLICK 1
#define DEF_MOUSE_SCROLL_MODE MOUSE_SCROLL_ALL
#define DEF_MOUSE_DIR_TRAILING_SLASH 1
