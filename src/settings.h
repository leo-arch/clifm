 ...
 * The overwrite prompt accepts these additional values:
 * a=all, o=none, s=skip, k=skip all, q=quit */
#define DEF_ANSWER_BULK_RENAME 'n' /* 'br' command */
#define DEF_ANSWER_OVERWRITE   'o' /* 'c' and 'm' commands mostly */
...
#define DEF_COLORS 1
#define DEF_COLORIZE_LNK_AS_TARGET 0
...
/* Possible values: LNK_CREAT_LITERAL, LNK_CREAT_ABSOLUTE,
 * and LNK_CREAT_RELATIVE */
#define DEF_LINK_CREATION_MODE LNK_CREAT_RELATIVE
 ...
 * MAX_NAMELEN_AUTO (term_columns * MAX_NAMELEN_AUTO_RATIO) */
#define DEF_MAX_NAME_LEN MAX_NAMELEN_AUTO
#define DEF_MAX_NAMELEN_AUTO_RATIO 25 /* 25% of terminal columns */
...
#define DEF_TERM_TITLE -1 /* auto: try to detect support */
...
/* We have two pattern matching styles: GLOB_MATCH and REGEX_MATCH */
#define DEF_MATCHING_STYLE GLOB_MATCH
