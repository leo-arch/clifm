...
print_tips(const int all)
{
	const char *TIPS[] = {
		...
		"Select files here and there with the 's' command: 's FILE...'",
		...
		"Add a new bookmark by just entering 'bm add FILENAME BM_NAME'",
		...
		"Get a brief description for each CliFM command via 'cmd<TAB>'",
		"Print the currently used color codes by entering 'colors'",
		...
		"Press F8 to open and edit the current color scheme file",
