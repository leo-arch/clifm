...
# endif /* __linux__ */
		...
		"ELN's and the 'sel' keyword work for shell commands as well. E.g.: "
		"'ls -ld 1 sel'",
		...
		"The search function allows regular expressions. E.g.: '/^c'",
		...
		"Space is not needed. E.g.: 'p12' instead of 'p 12'",
		...
		"Clean up non-ASCII filenames using the 'bleach' command",
		...
		"Press Ctrl+Alt+l to toggle max filename length on/off",
		"Wildcards can be expanded via TAB. E.g.: 's *.c<TAB>'",
