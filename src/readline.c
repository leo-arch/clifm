...
/* Get short and long options for command CMD from the fish autogenerated
 * completions file, store them in the EXT_OPTS array and return
 * the number of options found */
static int
get_ext_opts_fish(char *cmd)
{
	*ext_opts[0] = '\0';
