...
int_cmds_generator(const char *text, int state)
{
	...
	static const char *const cmd_desc[] = {
		...
		"view    (preview files in full-screen)",
...
int_z_cmds_generator(const char *text, int state)
{
	...
	static const char *const cmd_desc[] = {
		...
		"zp (preview files in full-screen)",
...
#define MAX_OPTS 23
	...
	static struct cmd_opts_t cmd_opts[] = {
		...
		{"pwd", {"-L", "-P", NULL}},
		{"sd", {"first", "last", "asfiles", NULL}},
		{"sort-dirs", {"first", "last", "asfiles", NULL}},
